...
(function(){
  function initContact(){
    ...
    card.setAttribute('aria-label','Contact details');
    card.innerHTML = `
      <h4>Contact</h4>
      <div class="row"><span class="label">Call</span> <a href="tel:0410937558">0410 937 558</a></div>
      <div class="row"><span class="label">Email</span> <a href="mailto:pro3dsydney@gmail.com">pro3dsydney@gmail.com</a></div>
    `;
    ...
    btn.addEventListener('click', ()=>{
      ...
      btn.textContent = open ? 'Close' : 'Get in touch';
      btn.setAttribute('aria-expanded', open);
    });
    document.addEventListener('keydown', (e)=>{
      if (e.key === 'Escape' && card.classList.contains('show')){
        card.classList.remove('show'); btn.textContent = 'Get in touch'; btn.setAttribute('aria-expanded','false');
      }
    });
  }
